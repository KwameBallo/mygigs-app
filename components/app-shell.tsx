...
export async function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const items = {
    home: { href: "/", label: n.home, icon: "home" } as NavItem,
    discover: { href: "/discover", label: n.discover, icon: "map" } as NavItem,
    admin: { href: "/admin", label: n.admin, icon: "settings" } as NavItem,
    bookings: {
      href: "/bookings",
      label: n.bookings,
      icon: "calendar",
    ...
    profile: { href: "/profile", label: n.profile, icon: "user" } as NavItem,
    settings: {
      href: "/settings",
      label: n.settings,
      icon: "settings",
  ...
  if (profile?.role === "admin") {
    sections.push({ title: n.sectionAdmin, items: [items.admin] })
  }
        ...
        <div className="mt-8 flex-1 overflow-y-auto">
          ...
          {profile && !isArtist && (
            ...
            >
              ...
              <span className="flex-1">{n.becomeDj}</span>
            </Link>
          )}
        </div>
