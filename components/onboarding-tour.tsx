...
const nl: Dict = {
  ...
  stepLabel: "Stap {n} / {t}",
  bookerSteps: [
    { sel: 'a[href="/discover"]', title: "Ontdek DJ's", body: "Tik op Ontdek en scroll door de DJ's op de kaart. Vind je match." },
    { sel: '[data-tour="discover-search"]', page: "/discover", title: "Zoek & filter", body: "Zoek op naam of stad, of gooi de filters open. Zo vind je precies jouw sound." },
    { sel: 'a[href="/bookings"]', page: "/bookings", title: "Je boekingen", body: "Boekingen, facturen én reviews: allemaal hier. Easy." },
    { title: "Je bent klaar 🎉", body: "Boom. Ga die perfecte DJ regelen." },
  ],
  djSteps: [
    { sel: 'a[href="/profile"]', title: "Je profiel", body: "Eerst even shinen: profiel, foto's en je tarief. Laat zien wat je kan." },
    ...
    { sel: 'a[href="/availability"]', page: "/availability", title: "Beschikbaarheid", body: "Wanneer kun je? Zet je datums en laat je boeken." },
    { sel: 'a[href="/dashboard"]', page: "/dashboard", title: "Aanvragen", body: "Boekingen landen op je dashboard. Accepteren en draaien maar." },
...
const en: Dict = {
  ...
  stepLabel: "Step {n} / {t}",
  bookerSteps: [
    { sel: 'a[href="/discover"]', title: "Discover DJs", body: "Hit Discover and scroll the DJs on the map. Find your match." },
    { sel: '[data-tour="discover-search"]', page: "/discover", title: "Search & filter", body: "Search by name or city, or open the filters. Lock in your sound." },
    { sel: 'a[href="/bookings"]', page: "/bookings", title: "Your bookings", body: "Bookings, invoices and reviews: all right here. Easy." },
    { title: "You're set 🎉", body: "Boom. Go lock in the perfect DJ." },
  ],
  djSteps: [
    { sel: 'a[href="/profile"]', title: "Your profile", body: "Shine first: profile, photos and your rate. Show what you got." },
    ...
    { sel: 'a[href="/availability"]', page: "/availability", title: "Availability", body: "When are you free? Drop your dates and get booked." },
    { sel: 'a[href="/dashboard"]', page: "/dashboard", title: "Requests", body: "Bookings land on your dashboard. Accept and play." },
