...
const nl = {
  ...
  auth: {
    ...
    pwRuleTitle: "Je wachtwoord heeft nog nodig:",
    pwRuleAllDone: "Je wachtwoord voldoet aan alle eisen.",
    pwRuleLength: "Minimaal 12 tekens",
    pwRuleUpper: "Een hoofdletter",
    pwRuleLower: "Een kleine letter",
    pwRuleDigit: "Een cijfer",
    pwRuleIncomplete: "Je wachtwoord voldoet nog niet aan alle eisen.",
    pwRuleMet: "voldaan",
    pwRuleNotMet: "nog niet voldaan",
...
const en: typeof nl = {
  ...
  auth: {
    ...
    pwRuleTitle: "Your password still needs:",
    pwRuleAllDone: "Your password meets all requirements.",
    pwRuleLength: "At least 12 characters",
    pwRuleUpper: "One capital letter",
    pwRuleLower: "One lowercase letter",
    pwRuleDigit: "One digit",
    pwRuleIncomplete: "Your password does not meet all the requirements yet.",
    pwRuleMet: "met",
    pwRuleNotMet: "not met yet",
