const nl = {
  metaTitle: "Algemene voorwaarden · MyGigs",
  back: "← Terug",
  title: "Algemene voorwaarden",
  updated: "Laatst bijgewerkt: {date}",
  sections: [
    {
      heading: "1. Over MyGigs",
      body: 'MyGigs is een online platform dat organisatoren en particulieren ("boekers") in contact brengt met DJ\'s en artiesten. MyGigs bemiddelt bij de totstandkoming en afwikkeling van boekingen, maar voert de optredens niet zelf uit. De overeenkomst voor een optreden komt tot stand tussen de boeker en de DJ.',
    },
    {
      heading: "2. Je account",
      body: "Om te boeken maak je een account aan met juiste en volledige gegevens. Je bent zelf verantwoordelijk voor het geheimhouden van je wachtwoord. Je bevestigt je e-mailadres voordat je kunt boeken of betalen.",
    },
    {
      heading: "3. Boeken en de overeenkomst",
      body: "Een boeking is een aanvraag aan een DJ. Zodra de DJ de aanvraag accepteert, ontstaat er een overeenkomst tussen jou en de DJ tegen de getoonde gage en voorwaarden.",
    },
    {
      heading: "4. Betaling en escrow",
...
const en: typeof nl = {
  metaTitle: "Terms and conditions · MyGigs",
  back: "← Back",
  title: "Terms and conditions",
  updated: "Last updated: {date}",
  sections: [
    {
      heading: "1. About MyGigs",
      body: 'MyGigs is an online platform that connects organisers and private individuals ("bookers") with DJs and artists. MyGigs facilitates the creation and settlement of bookings but does not perform the gigs itself. The agreement for a gig is concluded between the booker and the DJ.',
    },
    {
      heading: "2. Your account",
      body: "To make a booking you create an account with accurate and complete details. You are responsible for keeping your password confidential. You confirm your email address before you can book or pay.",
    },
    {
      heading: "3. Booking and the agreement",
      body: "A booking is a request to a DJ. As soon as the DJ accepts the request, an agreement is formed between you and the DJ at the fee and terms shown.",
    },
    {
      heading: "4. Payment and escrow",
