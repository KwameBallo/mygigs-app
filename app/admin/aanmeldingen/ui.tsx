...
const MESSAGES: Record<string, { key: keyof D; tone: "ok" | "bad" }> = {
  ...
  approvedMailed: { key: "msgApprovedMailed", tone: "ok" },
  claimMailed: { key: "msgClaimMailed", tone: "ok" },
  claimMailFailed: { key: "msgClaimMailFailed", tone: "bad" },
  photoRemoved: { key: "msgPhotoRemoved", tone: "ok" },
